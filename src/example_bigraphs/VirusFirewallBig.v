...
Program Definition my_parent (x : nodes + 'I_numb_sites) : nodes + 'I_numb_roots :=
  match x with  
  | inl (@SeqSub _ _ 70 _) => inl (@SeqSub _ _ 7 _)
  | inl (@SeqSub _ _ 71 _) => inl (@SeqSub _ _ 7 _)
  | inl (@SeqSub _ _ 72 _) => inl (@SeqSub _ _ 7 _)
  | inl (@SeqSub _ _ 80 _) => inl (@SeqSub _ _ 8 _)
  | inl (@SeqSub _ _ 81 _) => inl (@SeqSub _ _ 8 _)
  | inl (@SeqSub _ _ 82 _) => inl (@SeqSub _ _ 8 _)
  | inl (@SeqSub _ _ 83 _) => inl (@SeqSub _ _ 8 _)
  | inl (@SeqSub _ _ 90 _) => inl (@SeqSub _ _ 9 _)
  | inl (@SeqSub _ _ 91 _) => inl (@SeqSub _ _ 9 _)
  | inl (@SeqSub _ _ 40 _) => inl (@SeqSub _ _ 4 _)
  | inl (@SeqSub _ _ 41 _) => inl (@SeqSub _ _ 4 _)
  | inl (@SeqSub _ _ 42 _) => inl (@SeqSub _ _ 4 _)
  | inl (@SeqSub _ _ 43 _) => inl (@SeqSub _ _ 4 _)
  | inl (@SeqSub _ _ 50 _) => inl (@SeqSub _ _ 5 _)
  | inl (@SeqSub _ _ 51 _) => inl (@SeqSub _ _ 5 _)
  | inl (@SeqSub _ _ 52 _) => inl (@SeqSub _ _ 5 _)
  | inl (@SeqSub _ _ 53 _) => inl (@SeqSub _ _ 5 _)
  | inl (@SeqSub _ _ 54 _) => inl (@SeqSub _ _ 5 _)
  | inl (@SeqSub _ _ 60 _) => inl (@SeqSub _ _ 6 _)
  | inl (@SeqSub _ _ 61 _) => inl (@SeqSub _ _ 6 _)
  | inl (@SeqSub _ _ 62 _) => inl (@SeqSub _ _ 6 _)
  | inl (@SeqSub _ _ 63 _) => inl (@SeqSub _ _ 6 _)
  | inl (@SeqSub _ _ 10 _) => inl (@SeqSub _ _ 1 _)
  | inl (@SeqSub _ _ 11 _) => inl (@SeqSub _ _ 1 _)
  | inl (@SeqSub _ _ 12 _) => inl (@SeqSub _ _ 1 _)
  | inl (@SeqSub _ _ 20 _) => inl (@SeqSub _ _ 2 _)
  | inl (@SeqSub _ _ 21 _) => inl (@SeqSub _ _ 2 _)
  | inl (@SeqSub _ _ 22 _) => inl (@SeqSub _ _ 2 _)
  | inl (@SeqSub _ _ 23 _) => inl (@SeqSub _ _ 2 _)
  | inl (@SeqSub _ _ 30 _) => inl (@SeqSub _ _ 3 _)
  | inl (@SeqSub _ _ 31 _) => inl (@SeqSub _ _ 3 _)
  | inl (@SeqSub _ _ 32 _) => inl (@SeqSub _ _ 3 _)
...
Definition my_ap : MyBasics.FiniteParent my_parent.
  ...
  intro n.
  assert (Hroots: forall r, (r=S O \/ r=S (S O) \/ r=3 \/ r=4 \/ r=5 \/ r=6 \/ r=7 \/ r=8 \/ r=9) -> forall (ssvalP : r \in nodes_seq), Acc (fun n' n0 : nodes => my_parent (inl n0) = inl n') (@SeqSub _ _ r ssvalP)). 
  { intros r Hr.     
